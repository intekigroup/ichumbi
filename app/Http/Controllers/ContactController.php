...
class ContactController extends Controller
{
    ...
    public function postImportContacts(Request $request)
    {
        ...
        $contact_type = ! empty($contact) && ! empty($contact->type) ? $contact->type : null;
        $type = ! empty($contact_type) && $contact_type != 'both' ? $contact_type : 'supplier';
    ...
    public function getLedger()
    {
        ...
        if (request()->input('action') == 'pdf') {
            ...
            $mpdf->WriteHTML($html);
            $pdf = $mpdf->Output($output_file_name, 'S');
