...
function update_statistics(start, end) {
    ...
    $('.paid_debts').html(loader);
    $('.total_debt').html(loader);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('.paid_debts').html(__currency_trans_from_en(data.paid_debts, true));
            $('.total_debt').html(__currency_trans_from_en(data.total_debt, true));
            //expense details
